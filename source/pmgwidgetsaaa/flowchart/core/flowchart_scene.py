...
from PySide2.QtCore import QSize, QCoreApplication, QLineF, Qt, QPointF, QThread, Signal
from PySide2.QtGui import QPen, QColor, QKeyEvent, QWheelEvent, QCloseEvent
